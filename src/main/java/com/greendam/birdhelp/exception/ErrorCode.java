...
public enum ErrorCode {
    ...
    /** 项目名称重复（同一用户下） */
    PROJECT_NAME_EXISTS(40011, "项目名称已存在"),
     ...
     * 短信发送失败
     */
    SMS_SEND_ERROR(40012, "短信发送失败"),

    /**
     * 短信发送太频繁
     */
    SMS_TOO_FREQUENT(40013, "发送太频繁，请稍后再试"),

    /**
     * 今日短信发送次数已达上限
     */
    SMS_SEND_LIMIT_EXCEEDED(40014, "今日发送次数已达上限"),

    /**
     * 手机号未注册
     */
    PHONE_NOT_REGISTERED(40015, "该手机号未注册"),
     ...
     * 套餐不存在
     */
    PLAN_NOT_FOUND(40016, "套餐不存在"),

    /**
     * 套餐已下架
     */
    PLAN_DISABLED(40017, "套餐已下架"),

    /**
     * 订单不存在
     */
    ORDER_NOT_FOUND(40018, "订单不存在"),

    /**
     * 订单不属于当前用户
     */
    ORDER_NOT_YOURS(40019, "无权操作该订单"),

    /**
     * 订单已过期
     */
    ORDER_EXPIRED(40020, "订单已过期"),

    /**
     * 订单已支付
     */
    ORDER_ALREADY_PAID(40021, "订单已支付"),

    /**
     * 支付宝验签失败
     */
    ALIPAY_VERIFY_FAILED(40022, "支付验签失败"),

    /**
     * 支付回调处理异常
     */
    ALIPAY_NOTIFY_ERROR(40023, "支付回调处理异常"),
    ;
